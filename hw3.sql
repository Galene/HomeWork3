...
--
-- Host: localhost
-- Generation Time: Oct 30, 2013 at 06:36 PM
...
--
-- Table structure for table `bak_dj0kq_assets`
--

CREATE TABLE IF NOT EXISTS `bak_dj0kq_assets` (
...
--
-- Dumping data for table `bak_dj0kq_assets`
--

INSERT INTO `bak_dj0kq_assets` (`id`, `parent_id`, `lft`, `rgt`, `level`, `name`, `title`, `rules`) VALUES
...
--
-- Table structure for table `bak_dj0kq_associations`
--

CREATE TABLE IF NOT EXISTS `bak_dj0kq_associations` (
...
--
-- Table structure for table `bak_dj0kq_banners`
--

CREATE TABLE IF NOT EXISTS `bak_dj0kq_banners` (
...
--
-- Table structure for table `bak_dj0kq_banner_clients`
--

CREATE TABLE IF NOT EXISTS `bak_dj0kq_banner_clients` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `name` varchar(255) NOT NULL DEFAULT '',
...
--
-- Table structure for table `bak_dj0kq_banner_tracks`
--

CREATE TABLE IF NOT EXISTS `bak_dj0kq_banner_tracks` (
...
--
-- Table structure for table `bak_dj0kq_categories`
--

CREATE TABLE IF NOT EXISTS `bak_dj0kq_categories` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
...
--
-- Dumping data for table `bak_dj0kq_categories`
--

INSERT INTO `bak_dj0kq_categories` (`id`, `asset_id`, `parent_id`, `lft`, `rgt`, `level`, `path`, `extension`, `title`, `alias`, `note`, `description`, `published`, `checked_out`, `checked_out_time`, `access`, `params`, `metadesc`, `metakey`, `metadata`, `created_user_id`, `created_time`, `modified_user_id`, `modified_time`, `hits`, `language`) VALUES
...
--
-- Table structure for table `bak_dj0kq_contact_details`
--

CREATE TABLE IF NOT EXISTS `bak_dj0kq_contact_details` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `name` varchar(255) NOT NULL DEFAULT '',
  `alias` varchar(255) CHARACTER SET utf8 COLLATE utf8_bin NOT NULL DEFAULT '',
...
--
-- Table structure for table `bak_dj0kq_content`
--

CREATE TABLE IF NOT EXISTS `bak_dj0kq_content` (
...
--
-- Table structure for table `bak_dj0kq_content_frontpage`
--

CREATE TABLE IF NOT EXISTS `bak_dj0kq_content_frontpage` (
...
--
-- Table structure for table `bak_dj0kq_content_rating`
--

CREATE TABLE IF NOT EXISTS `bak_dj0kq_content_rating` (
  `content_id` int(11) NOT NULL DEFAULT '0',
...
--
-- Table structure for table `bak_dj0kq_core_log_searches`
--

CREATE TABLE IF NOT EXISTS `bak_dj0kq_core_log_searches` (
...
--
-- Table structure for table `bak_dj0kq_extensions`
--

CREATE TABLE IF NOT EXISTS `bak_dj0kq_extensions` (
...
--
-- Dumping data for table `bak_dj0kq_extensions`
--

INSERT INTO `bak_dj0kq_extensions` (`extension_id`, `name`, `type`, `element`, `folder`, `client_id`, `enabled`, `access`, `protected`, `manifest_cache`, `params`, `custom_data`, `system_data`, `checked_out`, `checked_out_time`, `ordering`, `state`) VALUES
...
--
-- Table structure for table `bak_dj0kq_finder_filters`
--

CREATE TABLE IF NOT EXISTS `bak_dj0kq_finder_filters` (
...
--
-- Table structure for table `bak_dj0kq_finder_links`
--

CREATE TABLE IF NOT EXISTS `bak_dj0kq_finder_links` (
...
--
-- Table structure for table `bak_dj0kq_finder_links_terms0`
--

CREATE TABLE IF NOT EXISTS `bak_dj0kq_finder_links_terms0` (
...
--
-- Table structure for table `bak_dj0kq_finder_links_terms1`
--

CREATE TABLE IF NOT EXISTS `bak_dj0kq_finder_links_terms1` (
  `link_id` int(10) unsigned NOT NULL,
  `term_id` int(10) unsigned NOT NULL,
  `weight` float unsigned NOT NULL,
  PRIMARY KEY (`link_id`,`term_id`),
...
--
-- Table structure for table `bak_dj0kq_finder_links_terms2`
--

CREATE TABLE IF NOT EXISTS `bak_dj0kq_finder_links_terms2` (
  `link_id` int(10) unsigned NOT NULL,
  `term_id` int(10) unsigned NOT NULL,
  `weight` float unsigned NOT NULL,
  PRIMARY KEY (`link_id`,`term_id`),
...
--
-- Table structure for table `bak_dj0kq_finder_links_terms3`
--

CREATE TABLE IF NOT EXISTS `bak_dj0kq_finder_links_terms3` (
  `link_id` int(10) unsigned NOT NULL,
  `term_id` int(10) unsigned NOT NULL,
  `weight` float unsigned NOT NULL,
  PRIMARY KEY (`link_id`,`term_id`),
...
--
-- Table structure for table `bak_dj0kq_finder_links_terms4`
--

CREATE TABLE IF NOT EXISTS `bak_dj0kq_finder_links_terms4` (
  `link_id` int(10) unsigned NOT NULL,
  `term_id` int(10) unsigned NOT NULL,
  `weight` float unsigned NOT NULL,
  PRIMARY KEY (`link_id`,`term_id`),
...
--
-- Table structure for table `bak_dj0kq_finder_links_terms5`
--

CREATE TABLE IF NOT EXISTS `bak_dj0kq_finder_links_terms5` (
  `link_id` int(10) unsigned NOT NULL,
  `term_id` int(10) unsigned NOT NULL,
  `weight` float unsigned NOT NULL,
  PRIMARY KEY (`link_id`,`term_id`),
...
--
-- Table structure for table `bak_dj0kq_finder_links_terms6`
--

CREATE TABLE IF NOT EXISTS `bak_dj0kq_finder_links_terms6` (
  `link_id` int(10) unsigned NOT NULL,
  `term_id` int(10) unsigned NOT NULL,
  `weight` float unsigned NOT NULL,
  PRIMARY KEY (`link_id`,`term_id`),
...
--
-- Table structure for table `bak_dj0kq_finder_links_terms7`
--

CREATE TABLE IF NOT EXISTS `bak_dj0kq_finder_links_terms7` (
  `link_id` int(10) unsigned NOT NULL,
  `term_id` int(10) unsigned NOT NULL,
  `weight` float unsigned NOT NULL,
  PRIMARY KEY (`link_id`,`term_id`),
...
--
-- Table structure for table `bak_dj0kq_finder_links_terms8`
--

CREATE TABLE IF NOT EXISTS `bak_dj0kq_finder_links_terms8` (
  `link_id` int(10) unsigned NOT NULL,
  `term_id` int(10) unsigned NOT NULL,
  `weight` float unsigned NOT NULL,
  PRIMARY KEY (`link_id`,`term_id`),
...
--
-- Table structure for table `bak_dj0kq_finder_links_terms9`
--

CREATE TABLE IF NOT EXISTS `bak_dj0kq_finder_links_terms9` (
  `link_id` int(10) unsigned NOT NULL,
  `term_id` int(10) unsigned NOT NULL,
  `weight` float unsigned NOT NULL,
  PRIMARY KEY (`link_id`,`term_id`),
...
--
-- Table structure for table `bak_dj0kq_finder_links_termsa`
--

CREATE TABLE IF NOT EXISTS `bak_dj0kq_finder_links_termsa` (
  `link_id` int(10) unsigned NOT NULL,
  `term_id` int(10) unsigned NOT NULL,
  `weight` float unsigned NOT NULL,
  PRIMARY KEY (`link_id`,`term_id`),
...
--
-- Table structure for table `bak_dj0kq_finder_links_termsb`
--

CREATE TABLE IF NOT EXISTS `bak_dj0kq_finder_links_termsb` (
  `link_id` int(10) unsigned NOT NULL,
  `term_id` int(10) unsigned NOT NULL,
  `weight` float unsigned NOT NULL,
  PRIMARY KEY (`link_id`,`term_id`),
...
--
-- Table structure for table `bak_dj0kq_finder_links_termsc`
--

CREATE TABLE IF NOT EXISTS `bak_dj0kq_finder_links_termsc` (
  `link_id` int(10) unsigned NOT NULL,
  `term_id` int(10) unsigned NOT NULL,
  `weight` float unsigned NOT NULL,
  PRIMARY KEY (`link_id`,`term_id`),
...
--
-- Table structure for table `bak_dj0kq_finder_links_termsd`
--

CREATE TABLE IF NOT EXISTS `bak_dj0kq_finder_links_termsd` (
  `link_id` int(10) unsigned NOT NULL,
  `term_id` int(10) unsigned NOT NULL,
  `weight` float unsigned NOT NULL,
  PRIMARY KEY (`link_id`,`term_id`),
...
--
-- Table structure for table `bak_dj0kq_finder_links_termse`
--

CREATE TABLE IF NOT EXISTS `bak_dj0kq_finder_links_termse` (
  `link_id` int(10) unsigned NOT NULL,
  `term_id` int(10) unsigned NOT NULL,
  `weight` float unsigned NOT NULL,
  PRIMARY KEY (`link_id`,`term_id`),
...
--
-- Table structure for table `bak_dj0kq_finder_links_termsf`
--

CREATE TABLE IF NOT EXISTS `bak_dj0kq_finder_links_termsf` (
  `link_id` int(10) unsigned NOT NULL,
  `term_id` int(10) unsigned NOT NULL,
  `weight` float unsigned NOT NULL,
  PRIMARY KEY (`link_id`,`term_id`),
...
--
-- Table structure for table `bak_dj0kq_finder_taxonomy`
--

CREATE TABLE IF NOT EXISTS `bak_dj0kq_finder_taxonomy` (
  `id` int(10) unsigned NOT NULL AUTO_INCREMENT,
  `parent_id` int(10) unsigned NOT NULL DEFAULT '0',
  `title` varchar(255) NOT NULL,
...
--
-- Dumping data for table `bak_dj0kq_finder_taxonomy`
--

INSERT INTO `bak_dj0kq_finder_taxonomy` (`id`, `parent_id`, `title`, `state`, `access`, `ordering`) VALUES
(1, 0, 'ROOT', 0, 0, 0);

-- --------------------------------------------------------

--
-- Table structure for table `bak_dj0kq_finder_taxonomy_map`
--

CREATE TABLE IF NOT EXISTS `bak_dj0kq_finder_taxonomy_map` (
  `link_id` int(10) unsigned NOT NULL,
...
--
-- Table structure for table `bak_dj0kq_finder_terms`
--

CREATE TABLE IF NOT EXISTS `bak_dj0kq_finder_terms` (
...
--
-- Table structure for table `bak_dj0kq_finder_terms_common`
--

CREATE TABLE IF NOT EXISTS `bak_dj0kq_finder_terms_common` (
  `term` varchar(75) NOT NULL,
...
--
-- Dumping data for table `bak_dj0kq_finder_terms_common`
--

INSERT INTO `bak_dj0kq_finder_terms_common` (`term`, `language`) VALUES
('a', 'en'),
('about', 'en'),
('after', 'en'),
('ago', 'en'),
...
--
-- Table structure for table `bak_dj0kq_finder_tokens`
--

CREATE TABLE IF NOT EXISTS `bak_dj0kq_finder_tokens` (
  `term` varchar(75) NOT NULL,
  `stem` varchar(75) NOT NULL,
  `common` tinyint(1) unsigned NOT NULL DEFAULT '0',
  `phrase` tinyint(1) unsigned NOT NULL DEFAULT '0',
...
--
-- Table structure for table `bak_dj0kq_finder_tokens_aggregate`
--

CREATE TABLE IF NOT EXISTS `bak_dj0kq_finder_tokens_aggregate` (
  `term_id` int(10) unsigned NOT NULL,
...
--
-- Table structure for table `bak_dj0kq_finder_types`
--

CREATE TABLE IF NOT EXISTS `bak_dj0kq_finder_types` (
  `id` int(10) unsigned NOT NULL AUTO_INCREMENT,
...
--
-- Table structure for table `bak_dj0kq_languages`
--

CREATE TABLE IF NOT EXISTS `bak_dj0kq_languages` (
...
--
-- Dumping data for table `bak_dj0kq_languages`
--

INSERT INTO `bak_dj0kq_languages` (`lang_id`, `lang_code`, `title`, `title_native`, `sef`, `image`, `description`, `metakey`, `metadesc`, `sitename`, `published`, `access`, `ordering`) VALUES
(1, 'en-GB', 'English (UK)', 'English (UK)', 'en', 'en', '', '', '', '', 1, 0, 1);

-- --------------------------------------------------------

--
-- Table structure for table `bak_dj0kq_menu`
--

CREATE TABLE IF NOT EXISTS `bak_dj0kq_menu` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
...
--
-- Dumping data for table `bak_dj0kq_menu`
--

INSERT INTO `bak_dj0kq_menu` (`id`, `menutype`, `title`, `alias`, `note`, `path`, `link`, `type`, `published`, `parent_id`, `level`, `component_id`, `ordering`, `checked_out`, `checked_out_time`, `browserNav`, `access`, `img`, `template_style_id`, `params`, `lft`, `rgt`, `home`, `language`, `client_id`) VALUES
...
--
-- Table structure for table `bak_dj0kq_menu_types`
--

CREATE TABLE IF NOT EXISTS `bak_dj0kq_menu_types` (
  `id` int(10) unsigned NOT NULL AUTO_INCREMENT,
...
--
-- Dumping data for table `bak_dj0kq_menu_types`
--

INSERT INTO `bak_dj0kq_menu_types` (`id`, `menutype`, `title`, `description`) VALUES
(1, 'mainmenu', 'Main Menu', 'The main menu for the site');

-- --------------------------------------------------------

--
-- Table structure for table `bak_dj0kq_messages`
--

CREATE TABLE IF NOT EXISTS `bak_dj0kq_messages` (
...
--
-- Table structure for table `bak_dj0kq_messages_cfg`
--

CREATE TABLE IF NOT EXISTS `bak_dj0kq_messages_cfg` (
...
--
-- Table structure for table `bak_dj0kq_modules`
--

CREATE TABLE IF NOT EXISTS `bak_dj0kq_modules` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
...
--
-- Dumping data for table `bak_dj0kq_modules`
--

INSERT INTO `bak_dj0kq_modules` (`id`, `title`, `note`, `content`, `ordering`, `position`, `checked_out`, `checked_out_time`, `publish_up`, `publish_down`, `published`, `module`, `access`, `showtitle`, `params`, `client_id`, `language`) VALUES
...
--
-- Table structure for table `bak_dj0kq_modules_menu`
--

CREATE TABLE IF NOT EXISTS `bak_dj0kq_modules_menu` (
...
--
-- Dumping data for table `bak_dj0kq_modules_menu`
--

INSERT INTO `bak_dj0kq_modules_menu` (`moduleid`, `menuid`) VALUES
(1, 0),
(2, 0),
(3, 0),
(4, 0),
...
--
-- Table structure for table `bak_dj0kq_newsfeeds`
--

CREATE TABLE IF NOT EXISTS `bak_dj0kq_newsfeeds` (
  `catid` int(11) NOT NULL DEFAULT '0',
  `id` int(10) unsigned NOT NULL AUTO_INCREMENT,
...
--
-- Table structure for table `bak_dj0kq_overrider`
--

CREATE TABLE IF NOT EXISTS `bak_dj0kq_overrider` (
...
--
-- Table structure for table `bak_dj0kq_redirect_links`
--

CREATE TABLE IF NOT EXISTS `bak_dj0kq_redirect_links` (
  `id` int(10) unsigned NOT NULL AUTO_INCREMENT,
...
--
-- Table structure for table `bak_dj0kq_schemas`
--

CREATE TABLE IF NOT EXISTS `bak_dj0kq_schemas` (
...
--
-- Dumping data for table `bak_dj0kq_schemas`
--

INSERT INTO `bak_dj0kq_schemas` (`extension_id`, `version_id`) VALUES
(700, '2.5.14');

-- --------------------------------------------------------

--
-- Table structure for table `bak_dj0kq_session`
--

CREATE TABLE IF NOT EXISTS `bak_dj0kq_session` (
...
--
-- Table structure for table `bak_dj0kq_template_styles`
--

CREATE TABLE IF NOT EXISTS `bak_dj0kq_template_styles` (
  `id` int(10) unsigned NOT NULL AUTO_INCREMENT,
...
--
-- Dumping data for table `bak_dj0kq_template_styles`
--

INSERT INTO `bak_dj0kq_template_styles` (`id`, `template`, `client_id`, `home`, `title`, `params`) VALUES
...
--
-- Table structure for table `bak_dj0kq_updates`
--

CREATE TABLE IF NOT EXISTS `bak_dj0kq_updates` (
...
--
-- Table structure for table `bak_dj0kq_update_categories`
--

CREATE TABLE IF NOT EXISTS `bak_dj0kq_update_categories` (
...
--
-- Table structure for table `bak_dj0kq_update_sites`
--

CREATE TABLE IF NOT EXISTS `bak_dj0kq_update_sites` (
...
--
-- Dumping data for table `bak_dj0kq_update_sites`
--

INSERT INTO `bak_dj0kq_update_sites` (`update_site_id`, `name`, `type`, `location`, `enabled`, `last_check_timestamp`) VALUES
...
--
-- Table structure for table `bak_dj0kq_update_sites_extensions`
--

CREATE TABLE IF NOT EXISTS `bak_dj0kq_update_sites_extensions` (
...
--
-- Dumping data for table `bak_dj0kq_update_sites_extensions`
--

INSERT INTO `bak_dj0kq_update_sites_extensions` (`update_site_id`, `extension_id`) VALUES
(1, 700),
(2, 700),
(3, 600);
...
--
-- Table structure for table `bak_dj0kq_usergroups`
--

CREATE TABLE IF NOT EXISTS `bak_dj0kq_usergroups` (
  `id` int(10) unsigned NOT NULL AUTO_INCREMENT COMMENT 'Primary Key',
...
--
-- Dumping data for table `bak_dj0kq_usergroups`
--

INSERT INTO `bak_dj0kq_usergroups` (`id`, `parent_id`, `lft`, `rgt`, `title`) VALUES
(1, 0, 1, 20, 'Public'),
(2, 1, 6, 17, 'Registered'),
(3, 2, 7, 14, 'Author'),
(4, 3, 8, 11, 'Editor'),
...
--
-- Table structure for table `bak_dj0kq_users`
--

CREATE TABLE IF NOT EXISTS `bak_dj0kq_users` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `name` varchar(255) NOT NULL DEFAULT '',
...
--
-- Dumping data for table `bak_dj0kq_users`
--

INSERT INTO `bak_dj0kq_users` (`id`, `name`, `username`, `email`, `password`, `usertype`, `block`, `sendEmail`, `registerDate`, `lastvisitDate`, `activation`, `params`, `lastResetTime`, `resetCount`) VALUES
(554, 'Super User', 'root', 'galina.ck@gmail.com', 'ae1c95338f47de58cdde0fc6aa65cd2d:ul03szyg5WqdwLwQfweP5fT2GA7DwiHW', 'deprecated', 0, 1, '2013-10-23 19:46:09', '0000-00-00 00:00:00', '0', '', '0000-00-00 00:00:00', 0);

-- --------------------------------------------------------

--
-- Table structure for table `bak_dj0kq_user_notes`
--

CREATE TABLE IF NOT EXISTS `bak_dj0kq_user_notes` (
  `id` int(10) unsigned NOT NULL AUTO_INCREMENT,
  `user_id` int(10) unsigned NOT NULL DEFAULT '0',
  `catid` int(10) unsigned NOT NULL DEFAULT '0',
...
--
-- Table structure for table `bak_dj0kq_user_profiles`
--

CREATE TABLE IF NOT EXISTS `bak_dj0kq_user_profiles` (
...
--
-- Table structure for table `bak_dj0kq_user_usergroup_map`
--

CREATE TABLE IF NOT EXISTS `bak_dj0kq_user_usergroup_map` (
...
--
-- Dumping data for table `bak_dj0kq_user_usergroup_map`
--

INSERT INTO `bak_dj0kq_user_usergroup_map` (`user_id`, `group_id`) VALUES
(554, 8);

-- --------------------------------------------------------

--
-- Table structure for table `bak_dj0kq_viewlevels`
--

CREATE TABLE IF NOT EXISTS `bak_dj0kq_viewlevels` (
  `id` int(10) unsigned NOT NULL AUTO_INCREMENT COMMENT 'Primary Key',
  `title` varchar(100) NOT NULL DEFAULT '',
  `ordering` int(11) NOT NULL DEFAULT '0',
  `rules` varchar(5120) NOT NULL COMMENT 'JSON encoded access control.',
...
--
-- Dumping data for table `bak_dj0kq_viewlevels`
--

INSERT INTO `bak_dj0kq_viewlevels` (`id`, `title`, `ordering`, `rules`) VALUES
(1, 'Public', 0, '[1]'),
...
--
-- Table structure for table `bak_dj0kq_weblinks`
--

CREATE TABLE IF NOT EXISTS `bak_dj0kq_weblinks` (
  `id` int(10) unsigned NOT NULL AUTO_INCREMENT,
  `catid` int(11) NOT NULL DEFAULT '0',
...
--
-- Table structure for table `dj0kq_assets`
--

CREATE TABLE IF NOT EXISTS `dj0kq_assets` (
  `id` int(10) unsigned NOT NULL AUTO_INCREMENT COMMENT 'Primary Key',
  `parent_id` int(11) NOT NULL DEFAULT '0' COMMENT 'Nested set parent.',
  `lft` int(11) NOT NULL DEFAULT '0' COMMENT 'Nested set lft.',
  `rgt` int(11) NOT NULL DEFAULT '0' COMMENT 'Nested set rgt.',
...
--
-- Dumping data for table `dj0kq_assets`
--

INSERT INTO `dj0kq_assets` (`id`, `parent_id`, `lft`, `rgt`, `level`, `name`, `title`, `rules`) VALUES
...
(32, 24, 62, 63, 1, 'com_users.category.7', 'Uncategorised', '{"core.create":[],"core.delete":[],"core.edit":[],"core.edit.state":[]}'),
(33, 1, 71, 72, 1, 'com_finder', 'com_finder', '{"core.admin":{"7":1},"core.manage":{"6":1}}'),
(34, 1, 73, 74, 1, 'com_joomlaupdate', 'com_joomlaupdate', '{"core.admin":[],"core.manage":[],"core.delete":[],"core.edit.state":[]}'),
(35, 27, 19, 20, 3, 'com_content.article.1', 'Team', '{"core.delete":{"6":1},"core.edit":{"6":1,"4":1},"core.edit.state":{"6":1,"5":1}}'),
(36, 27, 21, 22, 3, 'com_content.article.2', 'Home', '{"core.delete":{"6":1},"core.edit":{"6":1,"4":1},"core.edit.state":{"6":1,"5":1}}'),
(37, 27, 23, 24, 3, 'com_content.article.3', 'site-description', '{"core.delete":{"6":1},"core.edit":{"6":1,"4":1},"core.edit.state":{"6":1,"5":1}}'),
(38, 27, 25, 26, 3, 'com_content.article.4', 'About GeekHub', '{"core.delete":{"6":1},"core.edit":{"6":1,"4":1},"core.edit.state":{"6":1,"5":1}}');

-- --------------------------------------------------------

--
-- Table structure for table `dj0kq_associations`
--

CREATE TABLE IF NOT EXISTS `dj0kq_associations` (
  `id` varchar(50) NOT NULL COMMENT 'A reference to the associated item.',
  `context` varchar(50) NOT NULL COMMENT 'The context of the associated item.',
  `key` char(32) NOT NULL COMMENT 'The key for the association computed from an md5 on associated ids.',
  PRIMARY KEY (`context`,`id`),
...
--
-- Table structure for table `dj0kq_banners`
--

CREATE TABLE IF NOT EXISTS `dj0kq_banners` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `cid` int(11) NOT NULL DEFAULT '0',
  `type` int(11) NOT NULL DEFAULT '0',
  `name` varchar(255) NOT NULL DEFAULT '',
...
--
-- Table structure for table `dj0kq_banner_clients`
--

CREATE TABLE IF NOT EXISTS `dj0kq_banner_clients` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `name` varchar(255) NOT NULL DEFAULT '',
  `contact` varchar(255) NOT NULL DEFAULT '',
  `email` varchar(255) NOT NULL DEFAULT '',
...
--
-- Table structure for table `dj0kq_banner_tracks`
--

CREATE TABLE IF NOT EXISTS `dj0kq_banner_tracks` (
  `track_date` datetime NOT NULL,
  `track_type` int(10) unsigned NOT NULL,
  `banner_id` int(10) unsigned NOT NULL,
  `count` int(10) unsigned NOT NULL DEFAULT '0',
...
--
-- Table structure for table `dj0kq_categories`
--

CREATE TABLE IF NOT EXISTS `dj0kq_categories` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `asset_id` int(10) unsigned NOT NULL DEFAULT '0' COMMENT 'FK to the #__assets table.',
  `parent_id` int(10) unsigned NOT NULL DEFAULT '0',
  `lft` int(11) NOT NULL DEFAULT '0',
...
--
-- Dumping data for table `dj0kq_categories`
--

INSERT INTO `dj0kq_categories` (`id`, `asset_id`, `parent_id`, `lft`, `rgt`, `level`, `path`, `extension`, `title`, `alias`, `note`, `description`, `published`, `checked_out`, `checked_out_time`, `access`, `params`, `metadesc`, `metakey`, `metadata`, `created_user_id`, `created_time`, `modified_user_id`, `modified_time`, `hits`, `language`) VALUES
(1, 0, 0, 0, 13, 0, '', 'system', 'ROOT', 'root', '', '', 1, 0, '0000-00-00 00:00:00', 1, '{}', '', '', '', 0, '2009-10-18 16:07:09', 0, '0000-00-00 00:00:00', 0, '*'),
(2, 27, 1, 1, 2, 1, 'uncategorised', 'com_content', 'Uncategorised', 'uncategorised', '', '', 1, 0, '0000-00-00 00:00:00', 1, '{"target":"","image":""}', '', '', '{"page_title":"","author":"","robots":""}', 42, '2010-06-28 13:26:37', 0, '0000-00-00 00:00:00', 0, '*'),
(3, 28, 1, 3, 4, 1, 'uncategorised', 'com_banners', 'Uncategorised', 'uncategorised', '', '', 1, 0, '0000-00-00 00:00:00', 1, '{"target":"","image":"","foobar":""}', '', '', '{"page_title":"","author":"","robots":""}', 42, '2010-06-28 13:27:35', 0, '0000-00-00 00:00:00', 0, '*'),
(4, 29, 1, 5, 6, 1, 'uncategorised', 'com_contact', 'Uncategorised', 'uncategorised', '', '', 1, 0, '0000-00-00 00:00:00', 1, '{"target":"","image":""}', '', '', '{"page_title":"","author":"","robots":""}', 42, '2010-06-28 13:27:57', 0, '0000-00-00 00:00:00', 0, '*'),
...
--
-- Table structure for table `dj0kq_contact_details`
--

CREATE TABLE IF NOT EXISTS `dj0kq_contact_details` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `name` varchar(255) NOT NULL DEFAULT '',
  `alias` varchar(255) CHARACTER SET utf8 COLLATE utf8_bin NOT NULL DEFAULT '',
  `con_position` varchar(255) DEFAULT NULL,
...
--
-- Table structure for table `dj0kq_content`
--

CREATE TABLE IF NOT EXISTS `dj0kq_content` (
  `id` int(10) unsigned NOT NULL AUTO_INCREMENT,
  `asset_id` int(10) unsigned NOT NULL DEFAULT '0' COMMENT 'FK to the #__assets table.',
  `title` varchar(255) NOT NULL DEFAULT '',
  `alias` varchar(255) CHARACTER SET utf8 COLLATE utf8_bin NOT NULL DEFAULT '',
...
--
-- Dumping data for table `dj0kq_content`
--

INSERT INTO `dj0kq_content` (`id`, `asset_id`, `title`, `alias`, `title_alias`, `introtext`, `fulltext`, `state`, `sectionid`, `mask`, `catid`, `created`, `created_by`, `created_by_alias`, `modified`, `modified_by`, `checked_out`, `checked_out_time`, `publish_up`, `publish_down`, `images`, `urls`, `attribs`, `version`, `parentid`, `ordering`, `metakey`, `metadesc`, `access`, `hits`, `metadata`, `featured`, `language`, `xreference`) VALUES
(1, 35, 'Team', 'geekhub', '', '<h2>GeekHub Team</h2>', '', 1, 0, 0, 2, '2013-10-26 14:02:10', 791, '', '2013-10-30 09:55:45', 791, 0, '0000-00-00 00:00:00', '2013-10-26 14:02:10', '0000-00-00 00:00:00', '{"image_intro":"","float_intro":"","image_intro_alt":"","image_intro_caption":"","image_fulltext":"","float_fulltext":"","image_fulltext_alt":"","image_fulltext_caption":""}', '{"urla":false,"urlatext":"","targeta":"","urlb":false,"urlbtext":"","targetb":"","urlc":false,"urlctext":"","targetc":""}', '{"show_title":"","link_titles":"","show_intro":"","show_category":"","link_category":"","show_parent_category":"","link_parent_category":"","show_author":"","link_author":"","show_create_date":"","show_modify_date":"","show_publish_date":"","show_item_navigation":"","show_icons":"","show_print_icon":"","show_email_icon":"","show_vote":"","show_hits":"","show_noauth":"","urls_position":"","alternative_readmore":"","article_layout":"","show_publishing_options":"","show_article_options":"","show_urls_images_backend":"","show_urls_images_frontend":""}', 2, 0, 3, '', '', 1, 24, '{"robots":"","author":"","rights":"","xreference":""}', 0, '*', ''),
(2, 36, 'Home', 'home', '', '<p>Lorem ipsum dolor sit amet, consectetur adipiscing elit. Donec malesuada, justo vitae dictum dapibus, ligula nibh placerat metus, nec vehicula enim ipsum eget turpis. Nunc et dictum arcu. Ut sollicitudin eu orci sed condimentum. Sed in suscipit arcu, id tincidunt justo. Duis non augue eget ipsum gravida ultricies. Etiam nulla magna, pulvinar quis tortor a, vestibulum tincidunt justo. Pellentesque sed dapibus dolor. Fusce dapibus dignissim justo, vel dignissim justo consequat in. Integer ac bibendum urna, quis tristique mi.</p>\r\n<p>Etiam sed viverra velit, eu congue nisl. In suscipit non mi sit amet rhoncus. Pellentesque dolor ligula, pellentesque et dui vitae, ullamcorper malesuada sapien. Aenean tincidunt a massa at gravida. Quisque in sollicitudin nunc, sed iaculis dui. Sed venenatis ligula eget magna porttitor malesuada. Curabitur at risus sit amet dui tristique varius id ac magna. Sed eu nunc laoreet mi lobortis porttitor. Nunc consectetur ipsum nunc, et consequat orci dignissim eu. Donec vel ipsum bibendum lorem suscipit cursus. Curabitur vehicula nec quam ut fermentum. Vestibulum non fringilla metus. Curabitur in pharetra turpis, eu dignissim leo. Curabitur interdum purus urna. Praesent condimentum, diam tincidunt bibendum volutpat, lacus risus feugiat ipsum, eget tempus nisi arcu non urna.</p>\r\n<p>Sed fermentum tristique consectetur. Nulla dignissim ullamcorper arcu at pretium. Ut ac tincidunt metus. Donec lacinia semper condimentum. Aliquam blandit leo eget turpis pharetra, vel commodo turpis posuere. Curabitur interdum ultrices ante eget feugiat. Interdum et malesuada fames ac ante ipsum primis in faucibus. Cras diam nunc, tincidunt non molestie sit amet, elementum eget nisi. Aenean ipsum sem, hendrerit vitae ultricies sed, venenatis quis massa. Curabitur pulvinar, est id pellentesque scelerisque, urna leo dapibus nunc, quis egestas tortor lorem quis ligula. Mauris odio velit, venenatis eu diam ut, tincidunt condimentum eros. Cras tempor, sem vitae consequat congue, nunc eros porta tortor, eget mollis mi nisi vitae risus. Nunc non tempus arcu, sit amet viverra lacus. Sed massa leo, auctor ac aliquam eget, sagittis at urna. Phasellus non mi eget ante interdum ultricies. Sed nec pulvinar dolor.</p>', '', 1, 0, 0, 2, '2013-10-29 06:59:12', 791, '', '0000-00-00 00:00:00', 0, 0, '0000-00-00 00:00:00', '2013-10-29 06:59:12', '0000-00-00 00:00:00', '{"image_intro":"","float_intro":"","image_intro_alt":"","image_intro_caption":"","image_fulltext":"","float_fulltext":"","image_fulltext_alt":"","image_fulltext_caption":""}', '{"urla":false,"urlatext":"","targeta":"","urlb":false,"urlbtext":"","targetb":"","urlc":false,"urlctext":"","targetc":""}', '{"show_title":"","link_titles":"","show_intro":"","show_category":"","link_category":"","show_parent_category":"","link_parent_category":"","show_author":"","link_author":"","show_create_date":"","show_modify_date":"","show_publish_date":"","show_item_navigation":"","show_icons":"","show_print_icon":"","show_email_icon":"","show_vote":"","show_hits":"","show_noauth":"","urls_position":"","alternative_readmore":"","article_layout":"","show_publishing_options":"","show_article_options":"","show_urls_images_backend":"","show_urls_images_frontend":""}', 1, 0, 2, '', '', 1, 88, '{"robots":"","author":"","rights":"","xreference":""}', 0, '*', ''),
(3, 37, 'site-description', 'site-description', '', '<p>Reegistration</p>', '', 1, 0, 0, 2, '2013-10-29 09:38:41', 791, '', '0000-00-00 00:00:00', 0, 0, '0000-00-00 00:00:00', '2013-10-29 09:38:41', '0000-00-00 00:00:00', '{"image_intro":"","float_intro":"","image_intro_alt":"","image_intro_caption":"","image_fulltext":"","float_fulltext":"","image_fulltext_alt":"","image_fulltext_caption":""}', '{"urla":false,"urlatext":"","targeta":"","urlb":false,"urlbtext":"","targetb":"","urlc":false,"urlctext":"","targetc":""}', '{"show_title":"","link_titles":"","show_intro":"","show_category":"","link_category":"","show_parent_category":"","link_parent_category":"","show_author":"","link_author":"","show_create_date":"","show_modify_date":"","show_publish_date":"","show_item_navigation":"","show_icons":"","show_print_icon":"","show_email_icon":"","show_vote":"","show_hits":"","show_noauth":"","urls_position":"","alternative_readmore":"","article_layout":"","show_publishing_options":"","show_article_options":"","show_urls_images_backend":"","show_urls_images_frontend":""}', 1, 0, 1, '', '', 1, 0, '{"robots":"","author":"","rights":"","xreference":""}', 0, '*', ''),
(4, 38, 'About GeekHub', 'about-geekhub', '', '<p> </p>\r\n<p>Vivamus facilisis justo vitae hendrerit sagittis. Nunc sit amet dignissim tellus, lacinia mattis sapien. Aenean a lorem eleifend neque ullamcorper pulvinar quis vitae justo. Duis eu fringilla urna. Phasellus bibendum sem sed vulputate fringilla. Ut venenatis eros et arcu viverra, quis varius felis laoreet. Vivamus ut ornare est. Quisque nunc purus, commodo quis mattis ac, viverra quis justo. Nunc eleifend scelerisque nisl sed vehicula.</p>', '', 1, 0, 0, 2, '2013-10-29 20:36:55', 791, '', '0000-00-00 00:00:00', 0, 0, '0000-00-00 00:00:00', '2013-10-29 20:36:55', '0000-00-00 00:00:00', '{"image_intro":"images\\/about.png","float_intro":"","image_intro_alt":"","image_intro_caption":"","image_fulltext":"","float_fulltext":"","image_fulltext_alt":"","image_fulltext_caption":""}', '{"urla":false,"urlatext":"","targeta":"","urlb":false,"urlbtext":"","targetb":"","urlc":false,"urlctext":"","targetc":""}', '{"show_title":"","link_titles":"","show_intro":"","show_category":"","link_category":"","show_parent_category":"","link_parent_category":"","show_author":"","link_author":"","show_create_date":"","show_modify_date":"","show_publish_date":"","show_item_navigation":"","show_icons":"","show_print_icon":"","show_email_icon":"","show_vote":"","show_hits":"","show_noauth":"","urls_position":"","alternative_readmore":"","article_layout":"","show_publishing_options":"","show_article_options":"","show_urls_images_backend":"","show_urls_images_frontend":""}', 1, 0, 0, '', '', 1, 24, '{"robots":"","author":"","rights":"","xreference":""}', 0, '*', '');

-- --------------------------------------------------------

--
-- Table structure for table `dj0kq_content_frontpage`
--

CREATE TABLE IF NOT EXISTS `dj0kq_content_frontpage` (
  `content_id` int(11) NOT NULL DEFAULT '0',
  `ordering` int(11) NOT NULL DEFAULT '0',
  PRIMARY KEY (`content_id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8;
...
--
-- Table structure for table `dj0kq_content_rating`
--

CREATE TABLE IF NOT EXISTS `dj0kq_content_rating` (
  `content_id` int(11) NOT NULL DEFAULT '0',
  `rating_sum` int(10) unsigned NOT NULL DEFAULT '0',
  `rating_count` int(10) unsigned NOT NULL DEFAULT '0',
  `lastip` varchar(50) NOT NULL DEFAULT '',
...
--
-- Table structure for table `dj0kq_core_log_searches`
--

CREATE TABLE IF NOT EXISTS `dj0kq_core_log_searches` (
  `search_term` varchar(128) NOT NULL DEFAULT '',
  `hits` int(10) unsigned NOT NULL DEFAULT '0'
) ENGINE=InnoDB DEFAULT CHARSET=utf8;
...
--
-- Table structure for table `dj0kq_extensions`
--

CREATE TABLE IF NOT EXISTS `dj0kq_extensions` (
  `extension_id` int(11) NOT NULL AUTO_INCREMENT,
  `name` varchar(100) NOT NULL,
  `type` varchar(20) NOT NULL,
  `element` varchar(100) NOT NULL,
...
--
-- Dumping data for table `dj0kq_extensions`
--

INSERT INTO `dj0kq_extensions` (`extension_id`, `name`, `type`, `element`, `folder`, `client_id`, `enabled`, `access`, `protected`, `manifest_cache`, `params`, `custom_data`, `system_data`, `checked_out`, `checked_out_time`, `ordering`, `state`) VALUES
(1, 'com_mailto', 'component', 'com_mailto', '', 0, 1, 1, 1, '{"legacy":false,"name":"com_mailto","type":"component","creationDate":"April 2006","author":"Joomla! Project","copyright":"(C) 2005 - 2013 Open Source Matters. All rights reserved.\\t","authorEmail":"admin@joomla.org","authorUrl":"www.joomla.org","version":"2.5.0","description":"COM_MAILTO_XML_DESCRIPTION","group":""}', '', '', '', 0, '0000-00-00 00:00:00', 0, 0),
(2, 'com_wrapper', 'component', 'com_wrapper', '', 0, 1, 1, 1, '{"legacy":false,"name":"com_wrapper","type":"component","creationDate":"April 2006","author":"Joomla! Project","copyright":"(C) 2005 - 2013 Open Source Matters. All rights reserved.\\n\\t","authorEmail":"admin@joomla.org","authorUrl":"www.joomla.org","version":"2.5.0","description":"COM_WRAPPER_XML_DESCRIPTION","group":""}', '', '', '', 0, '0000-00-00 00:00:00', 0, 0),
(3, 'com_admin', 'component', 'com_admin', '', 1, 1, 1, 1, '{"legacy":false,"name":"com_admin","type":"component","creationDate":"April 2006","author":"Joomla! Project","copyright":"(C) 2005 - 2013 Open Source Matters. All rights reserved.\\n\\t","authorEmail":"admin@joomla.org","authorUrl":"www.joomla.org","version":"2.5.0","description":"COM_ADMIN_XML_DESCRIPTION","group":""}', '', '', '', 0, '0000-00-00 00:00:00', 0, 0),
(4, 'com_banners', 'component', 'com_banners', '', 1, 1, 1, 0, '{"legacy":false,"name":"com_banners","type":"component","creationDate":"April 2006","author":"Joomla! Project","copyright":"(C) 2005 - 2013 Open Source Matters. All rights reserved.\\n\\t","authorEmail":"admin@joomla.org","authorUrl":"www.joomla.org","version":"2.5.0","description":"COM_BANNERS_XML_DESCRIPTION","group":""}', '{"purchase_type":"3","track_impressions":"0","track_clicks":"0","metakey_prefix":""}', '', '', 0, '0000-00-00 00:00:00', 0, 0),
...
(700, 'files_joomla', 'file', 'joomla', '', 0, 1, 1, 1, '{"legacy":false,"name":"files_joomla","type":"file","creationDate":"August 2013","author":"Joomla! Project","copyright":"(C) 2005 - 2013 Open Source Matters. All rights reserved","authorEmail":"admin@joomla.org","authorUrl":"www.joomla.org","version":"2.5.14","description":"FILES_JOOMLA_XML_DESCRIPTION","group":""}', '', '', '', 0, '0000-00-00 00:00:00', 0, 0),
(800, 'PKG_JOOMLA', 'package', 'pkg_joomla', '', 0, 1, 1, 1, '{"legacy":false,"name":"PKG_JOOMLA","type":"package","creationDate":"2006","author":"Joomla! Project","copyright":"Copyright (C) 2005 - 2013 Open Source Matters. All rights reserved.","authorEmail":"admin@joomla.org","authorUrl":"http:\\/\\/www.joomla.org","version":"2.5.0","description":"PKG_JOOMLA_XML_DESCRIPTION","group":""}', '', '', '', 0, '0000-00-00 00:00:00', 0, 0),
(801, 'hw3', 'template', 'hw3', '', 0, 1, 1, 0, '{"legacy":false,"name":"hw3","type":"template","creationDate":"24 Oct 2013","author":"Gala","copyright":"Copyright (C) 2013. All rights reserved.","authorEmail":"galina.ck@gmail.com","authorUrl":"","version":"2.5.0","description":"Home Work 3. Gala","group":""}', '{}', '', '', 0, '0000-00-00 00:00:00', 0, 0),
(806, 'hw3_01', 'template', 'hw3_01', '', 0, 1, 1, 0, '{"legacy":false,"name":"hw3_01","type":"template","creationDate":"28 Oct 2013","author":"Gala","copyright":"Copyright (C) 2013 All rights reserved.","authorEmail":"galina.ck@gmail.com","authorUrl":"","version":"2.5.0","description":"Home Work 3. Gala","group":""}', '{"wrapperSmall":"53","wrapperLarge":"72","sitetitle":"","sitedescription":"","navposition":"center","html5":"0"}', '', '', 0, '0000-00-00 00:00:00', 0, 0),
(807, 'hw3_main01', 'template', 'hw3_main01', '', 0, 1, 1, 0, '{"legacy":false,"name":"hw3_main01","type":"template","creationDate":"24 Oct 2013","author":"Gala","copyright":"Copyright (C) 2013. All rights reserved.","authorEmail":"galina.ck@gmail.com","authorUrl":"","version":"2.5.0","description":"Home Work 3.01","group":""}', '{"wrapperSmall":"53","wrapperLarge":"72","sitetitle":"","sitedescription":"","navposition":"center","html5":"0"}', '', '', 0, '0000-00-00 00:00:00', 0, 0),
(808, 'mod_social', 'module', 'mod_social', '', 0, 1, 1, 0, 'false', '{}', '', '', 0, '0000-00-00 00:00:00', 0, 0);

-- --------------------------------------------------------

--
-- Table structure for table `dj0kq_finder_filters`
--

CREATE TABLE IF NOT EXISTS `dj0kq_finder_filters` (
  `filter_id` int(10) unsigned NOT NULL AUTO_INCREMENT,
  `title` varchar(255) NOT NULL,
  `alias` varchar(255) NOT NULL,
  `state` tinyint(1) NOT NULL DEFAULT '1',
...
--
-- Table structure for table `dj0kq_finder_links`
--

CREATE TABLE IF NOT EXISTS `dj0kq_finder_links` (
  `link_id` int(10) unsigned NOT NULL AUTO_INCREMENT,
  `url` varchar(255) NOT NULL,
  `route` varchar(255) NOT NULL,
  `title` varchar(255) DEFAULT NULL,
...
--
-- Table structure for table `dj0kq_finder_links_terms0`
--

CREATE TABLE IF NOT EXISTS `dj0kq_finder_links_terms0` (
  `link_id` int(10) unsigned NOT NULL,
  `term_id` int(10) unsigned NOT NULL,
  `weight` float unsigned NOT NULL,
  PRIMARY KEY (`link_id`,`term_id`),
...
--
-- Table structure for table `dj0kq_finder_links_terms1`
--

CREATE TABLE IF NOT EXISTS `dj0kq_finder_links_terms1` (
  `link_id` int(10) unsigned NOT NULL,
  `term_id` int(10) unsigned NOT NULL,
  `weight` float unsigned NOT NULL,
  PRIMARY KEY (`link_id`,`term_id`),
...
--
-- Table structure for table `dj0kq_finder_links_terms2`
--

CREATE TABLE IF NOT EXISTS `dj0kq_finder_links_terms2` (
  `link_id` int(10) unsigned NOT NULL,
  `term_id` int(10) unsigned NOT NULL,
  `weight` float unsigned NOT NULL,
  PRIMARY KEY (`link_id`,`term_id`),
...
--
-- Table structure for table `dj0kq_finder_links_terms3`
--

CREATE TABLE IF NOT EXISTS `dj0kq_finder_links_terms3` (
  `link_id` int(10) unsigned NOT NULL,
  `term_id` int(10) unsigned NOT NULL,
  `weight` float unsigned NOT NULL,
  PRIMARY KEY (`link_id`,`term_id`),
...
--
-- Table structure for table `dj0kq_finder_links_terms4`
--

CREATE TABLE IF NOT EXISTS `dj0kq_finder_links_terms4` (
  `link_id` int(10) unsigned NOT NULL,
  `term_id` int(10) unsigned NOT NULL,
  `weight` float unsigned NOT NULL,
  PRIMARY KEY (`link_id`,`term_id`),
...
--
-- Table structure for table `dj0kq_finder_links_terms5`
--

CREATE TABLE IF NOT EXISTS `dj0kq_finder_links_terms5` (
  `link_id` int(10) unsigned NOT NULL,
  `term_id` int(10) unsigned NOT NULL,
  `weight` float unsigned NOT NULL,
  PRIMARY KEY (`link_id`,`term_id`),
...
--
-- Table structure for table `dj0kq_finder_links_terms6`
--

CREATE TABLE IF NOT EXISTS `dj0kq_finder_links_terms6` (
  `link_id` int(10) unsigned NOT NULL,
  `term_id` int(10) unsigned NOT NULL,
  `weight` float unsigned NOT NULL,
  PRIMARY KEY (`link_id`,`term_id`),
...
--
-- Table structure for table `dj0kq_finder_links_terms7`
--

CREATE TABLE IF NOT EXISTS `dj0kq_finder_links_terms7` (
  `link_id` int(10) unsigned NOT NULL,
  `term_id` int(10) unsigned NOT NULL,
  `weight` float unsigned NOT NULL,
  PRIMARY KEY (`link_id`,`term_id`),
...
--
-- Table structure for table `dj0kq_finder_links_terms8`
--

CREATE TABLE IF NOT EXISTS `dj0kq_finder_links_terms8` (
  `link_id` int(10) unsigned NOT NULL,
  `term_id` int(10) unsigned NOT NULL,
  `weight` float unsigned NOT NULL,
  PRIMARY KEY (`link_id`,`term_id`),
...
--
-- Table structure for table `dj0kq_finder_links_terms9`
--

CREATE TABLE IF NOT EXISTS `dj0kq_finder_links_terms9` (
  `link_id` int(10) unsigned NOT NULL,
  `term_id` int(10) unsigned NOT NULL,
  `weight` float unsigned NOT NULL,
  PRIMARY KEY (`link_id`,`term_id`),
...
--
-- Table structure for table `dj0kq_finder_links_termsa`
--

CREATE TABLE IF NOT EXISTS `dj0kq_finder_links_termsa` (
  `link_id` int(10) unsigned NOT NULL,
  `term_id` int(10) unsigned NOT NULL,
  `weight` float unsigned NOT NULL,
  PRIMARY KEY (`link_id`,`term_id`),
...
--
-- Table structure for table `dj0kq_finder_links_termsb`
--

CREATE TABLE IF NOT EXISTS `dj0kq_finder_links_termsb` (
  `link_id` int(10) unsigned NOT NULL,
  `term_id` int(10) unsigned NOT NULL,
  `weight` float unsigned NOT NULL,
  PRIMARY KEY (`link_id`,`term_id`),
...
--
-- Table structure for table `dj0kq_finder_links_termsc`
--

CREATE TABLE IF NOT EXISTS `dj0kq_finder_links_termsc` (
  `link_id` int(10) unsigned NOT NULL,
  `term_id` int(10) unsigned NOT NULL,
  `weight` float unsigned NOT NULL,
  PRIMARY KEY (`link_id`,`term_id`),
...
--
-- Table structure for table `dj0kq_finder_links_termsd`
--

CREATE TABLE IF NOT EXISTS `dj0kq_finder_links_termsd` (
  `link_id` int(10) unsigned NOT NULL,
  `term_id` int(10) unsigned NOT NULL,
  `weight` float unsigned NOT NULL,
  PRIMARY KEY (`link_id`,`term_id`),
...
--
-- Table structure for table `dj0kq_finder_links_termse`
--

CREATE TABLE IF NOT EXISTS `dj0kq_finder_links_termse` (
  `link_id` int(10) unsigned NOT NULL,
  `term_id` int(10) unsigned NOT NULL,
  `weight` float unsigned NOT NULL,
  PRIMARY KEY (`link_id`,`term_id`),
...
--
-- Table structure for table `dj0kq_finder_links_termsf`
--

CREATE TABLE IF NOT EXISTS `dj0kq_finder_links_termsf` (
  `link_id` int(10) unsigned NOT NULL,
  `term_id` int(10) unsigned NOT NULL,
  `weight` float unsigned NOT NULL,
  PRIMARY KEY (`link_id`,`term_id`),
...
--
-- Table structure for table `dj0kq_finder_taxonomy`
--

CREATE TABLE IF NOT EXISTS `dj0kq_finder_taxonomy` (
  `id` int(10) unsigned NOT NULL AUTO_INCREMENT,
  `parent_id` int(10) unsigned NOT NULL DEFAULT '0',
  `title` varchar(255) NOT NULL,
  `state` tinyint(1) unsigned NOT NULL DEFAULT '1',
...
--
-- Dumping data for table `dj0kq_finder_taxonomy`
--

INSERT INTO `dj0kq_finder_taxonomy` (`id`, `parent_id`, `title`, `state`, `access`, `ordering`) VALUES
(1, 0, 'ROOT', 0, 0, 0);

-- --------------------------------------------------------

--
-- Table structure for table `dj0kq_finder_taxonomy_map`
--

CREATE TABLE IF NOT EXISTS `dj0kq_finder_taxonomy_map` (
  `link_id` int(10) unsigned NOT NULL,
  `node_id` int(10) unsigned NOT NULL,
  PRIMARY KEY (`link_id`,`node_id`),
  KEY `link_id` (`link_id`),
...
--
-- Table structure for table `dj0kq_finder_terms`
--

CREATE TABLE IF NOT EXISTS `dj0kq_finder_terms` (
  `term_id` int(10) unsigned NOT NULL AUTO_INCREMENT,
  `term` varchar(75) NOT NULL,
  `stem` varchar(75) NOT NULL,
  `common` tinyint(1) unsigned NOT NULL DEFAULT '0',
...
--
-- Table structure for table `dj0kq_finder_terms_common`
--

CREATE TABLE IF NOT EXISTS `dj0kq_finder_terms_common` (
  `term` varchar(75) NOT NULL,
  `language` varchar(3) NOT NULL,
  KEY `idx_word_lang` (`term`,`language`),
  KEY `idx_lang` (`language`)
...
--
-- Dumping data for table `dj0kq_finder_terms_common`
--

INSERT INTO `dj0kq_finder_terms_common` (`term`, `language`) VALUES
('a', 'en'),
('about', 'en'),
('after', 'en'),
('ago', 'en'),
...
--
-- Table structure for table `dj0kq_finder_tokens`
--

CREATE TABLE IF NOT EXISTS `dj0kq_finder_tokens` (
  `term` varchar(75) NOT NULL,
  `stem` varchar(75) NOT NULL,
  `common` tinyint(1) unsigned NOT NULL DEFAULT '0',
  `phrase` tinyint(1) unsigned NOT NULL DEFAULT '0',
...
--
-- Table structure for table `dj0kq_finder_tokens_aggregate`
--

CREATE TABLE IF NOT EXISTS `dj0kq_finder_tokens_aggregate` (
  `term_id` int(10) unsigned NOT NULL,
  `map_suffix` char(1) NOT NULL,
  `term` varchar(75) NOT NULL,
  `stem` varchar(75) NOT NULL,
...
--
-- Table structure for table `dj0kq_finder_types`
--

CREATE TABLE IF NOT EXISTS `dj0kq_finder_types` (
  `id` int(10) unsigned NOT NULL AUTO_INCREMENT,
  `title` varchar(100) NOT NULL,
  `mime` varchar(100) NOT NULL,
  PRIMARY KEY (`id`),
...
--
-- Table structure for table `dj0kq_languages`
--

CREATE TABLE IF NOT EXISTS `dj0kq_languages` (
  `lang_id` int(11) unsigned NOT NULL AUTO_INCREMENT,
  `lang_code` char(7) NOT NULL,
  `title` varchar(50) NOT NULL,
  `title_native` varchar(50) NOT NULL,
...
--
-- Dumping data for table `dj0kq_languages`
--

INSERT INTO `dj0kq_languages` (`lang_id`, `lang_code`, `title`, `title_native`, `sef`, `image`, `description`, `metakey`, `metadesc`, `sitename`, `published`, `access`, `ordering`) VALUES
(1, 'en-GB', 'English (UK)', 'English (UK)', 'en', 'en', '', '', '', '', 1, 0, 1);

-- --------------------------------------------------------

--
-- Table structure for table `dj0kq_menu`
--

CREATE TABLE IF NOT EXISTS `dj0kq_menu` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `menutype` varchar(24) NOT NULL COMMENT 'The type of menu this item belongs to. FK to #__menu_types.menutype',
  `title` varchar(255) NOT NULL COMMENT 'The display title of the menu item.',
  `alias` varchar(255) CHARACTER SET utf8 COLLATE utf8_bin NOT NULL COMMENT 'The SEF alias of the menu item.',
...
--
-- Dumping data for table `dj0kq_menu`
--

INSERT INTO `dj0kq_menu` (`id`, `menutype`, `title`, `alias`, `note`, `path`, `link`, `type`, `published`, `parent_id`, `level`, `component_id`, `ordering`, `checked_out`, `checked_out_time`, `browserNav`, `access`, `img`, `template_style_id`, `params`, `lft`, `rgt`, `home`, `language`, `client_id`) VALUES
...
--
-- Dumping data for table `dj0kq_menu_types`
--

INSERT INTO `dj0kq_menu_types` (`id`, `menutype`, `title`, `description`) VALUES
(1, 'mainmenu', 'Main Menu', 'The main menu for the site');

-- --------------------------------------------------------

--
-- Table structure for table `dj0kq_messages`
--

CREATE TABLE IF NOT EXISTS `dj0kq_messages` (
  `message_id` int(10) unsigned NOT NULL AUTO_INCREMENT,
  `user_id_from` int(10) unsigned NOT NULL DEFAULT '0',
  `user_id_to` int(10) unsigned NOT NULL DEFAULT '0',
  `folder_id` tinyint(3) unsigned NOT NULL DEFAULT '0',
...
--
-- Table structure for table `dj0kq_messages_cfg`
--

CREATE TABLE IF NOT EXISTS `dj0kq_messages_cfg` (
  `user_id` int(10) unsigned NOT NULL DEFAULT '0',
  `cfg_name` varchar(100) NOT NULL DEFAULT '',
  `cfg_value` varchar(255) NOT NULL DEFAULT '',
  UNIQUE KEY `idx_user_var_name` (`user_id`,`cfg_name`)
...
--
-- Table structure for table `dj0kq_modules`
--

CREATE TABLE IF NOT EXISTS `dj0kq_modules` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `title` varchar(100) NOT NULL DEFAULT '',
  `note` varchar(255) NOT NULL DEFAULT '',
  `content` text NOT NULL,
...
--
-- Dumping data for table `dj0kq_modules`
--

INSERT INTO `dj0kq_modules` (`id`, `title`, `note`, `content`, `ordering`, `position`, `checked_out`, `checked_out_time`, `publish_up`, `publish_down`, `published`, `module`, `access`, `showtitle`, `params`, `client_id`, `language`) VALUES
(1, 'Main Menu', '', '', 1, 'atomic-topmenu', 0, '0000-00-00 00:00:00', '0000-00-00 00:00:00', '0000-00-00 00:00:00', 1, 'mod_menu', 1, 1, '{"menutype":"mainmenu","startLevel":"1","endLevel":"0","showAllChildren":"0","tag_id":"","class_sfx":"","window_open":"","layout":"_:default","moduleclass_sfx":"_menu","cache":"1","cache_time":"900","cachemode":"itemid"}', 0, '*'),
(2, 'Login', '', '', 1, 'login', 0, '0000-00-00 00:00:00', '0000-00-00 00:00:00', '0000-00-00 00:00:00', 1, 'mod_login', 1, 1, '', 1, '*'),
(3, 'Popular Articles', '', '', 3, 'cpanel', 0, '0000-00-00 00:00:00', '0000-00-00 00:00:00', '0000-00-00 00:00:00', 1, 'mod_popular', 3, 1, '{"count":"5","catid":"","user_id":"0","layout":"_:default","moduleclass_sfx":"","cache":"0","automatic_title":"1"}', 1, '*'),
(4, 'Recently Added Articles', '', '', 4, 'cpanel', 0, '0000-00-00 00:00:00', '0000-00-00 00:00:00', '0000-00-00 00:00:00', 1, 'mod_latest', 3, 1, '{"count":"5","ordering":"c_dsc","catid":"","user_id":"0","layout":"_:default","moduleclass_sfx":"","cache":"0","automatic_title":"1"}', 1, '*'),
(8, 'Toolbar', '', '', 1, 'toolbar', 0, '0000-00-00 00:00:00', '0000-00-00 00:00:00', '0000-00-00 00:00:00', 1, 'mod_toolbar', 3, 1, '', 1, '*'),
...
(79, 'Multilanguage status', '', '', 1, 'status', 0, '0000-00-00 00:00:00', '0000-00-00 00:00:00', '0000-00-00 00:00:00', 0, 'mod_multilangstatus', 3, 1, '{"layout":"_:default","moduleclass_sfx":"","cache":"0"}', 1, '*'),
(86, 'Joomla Version', '', '', 1, 'footer', 0, '0000-00-00 00:00:00', '0000-00-00 00:00:00', '0000-00-00 00:00:00', 1, 'mod_version', 3, 1, '{"format":"short","product":"1","layout":"_:default","moduleclass_sfx":"","cache":"0"}', 1, '*'),
(87, 'footer', '', '', 0, 'position-14', 0, '0000-00-00 00:00:00', '0000-00-00 00:00:00', '0000-00-00 00:00:00', 1, 'mod_footer', 1, 1, '{"layout":"_:default","moduleclass_sfx":"","cache":"1","cache_time":"900","cachemode":"static"}', 0, '*'),
(89, 'Footer-Menu', '', '', 1, 'footermenu', 0, '0000-00-00 00:00:00', '0000-00-00 00:00:00', '0000-00-00 00:00:00', 1, 'mod_menu', 1, 0, '{"menutype":"mainmenu","startLevel":"1","endLevel":"0","showAllChildren":"1","tag_id":"","class_sfx":"footermenu","window_open":"","layout":"_:default","moduleclass_sfx":"","cache":"1","cache_time":"900","cachemode":"itemid"}', 0, '*'),
(90, 'Home-Head', '', '', 0, 'position-3', 0, '0000-00-00 00:00:00', '0000-00-00 00:00:00', '0000-00-00 00:00:00', 1, 'mod_related_items', 1, 1, '{"showDate":"0","layout":"_:default","moduleclass_sfx":"homehead","owncache":"1"}', 0, '*');

-- --------------------------------------------------------

--
-- Table structure for table `dj0kq_modules_menu`
--

CREATE TABLE IF NOT EXISTS `dj0kq_modules_menu` (
  `moduleid` int(11) NOT NULL DEFAULT '0',
  `menuid` int(11) NOT NULL DEFAULT '0',
  PRIMARY KEY (`moduleid`,`menuid`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8;
...
--
-- Dumping data for table `dj0kq_modules_menu`
--

INSERT INTO `dj0kq_modules_menu` (`moduleid`, `menuid`) VALUES
(1, 0),
(2, 0),
(3, 0),
(4, 0),
...
--
-- Table structure for table `dj0kq_newsfeeds`
--

CREATE TABLE IF NOT EXISTS `dj0kq_newsfeeds` (
  `catid` int(11) NOT NULL DEFAULT '0',
  `id` int(10) unsigned NOT NULL AUTO_INCREMENT,
  `name` varchar(100) NOT NULL DEFAULT '',
  `alias` varchar(255) CHARACTER SET utf8 COLLATE utf8_bin NOT NULL DEFAULT '',
...
--
-- Table structure for table `dj0kq_overrider`
--

CREATE TABLE IF NOT EXISTS `dj0kq_overrider` (
  `id` int(10) NOT NULL AUTO_INCREMENT COMMENT 'Primary Key',
  `constant` varchar(255) NOT NULL,
  `string` text NOT NULL,
  `file` varchar(255) NOT NULL,
...
--
-- Table structure for table `dj0kq_redirect_links`
--

CREATE TABLE IF NOT EXISTS `dj0kq_redirect_links` (
  `id` int(10) unsigned NOT NULL AUTO_INCREMENT,
  `old_url` varchar(255) NOT NULL,
  `new_url` varchar(255) NOT NULL,
  `referer` varchar(150) NOT NULL,
...
--
-- Dumping data for table `dj0kq_redirect_links`
--

INSERT INTO `dj0kq_redirect_links` (`id`, `old_url`, `new_url`, `referer`, `comment`, `hits`, `published`, `created_date`, `modified_date`) VALUES
(1, 'http://hw3/index.php?Itemid=103', '', 'http://hw3/index.php/geekhub', '', 1, 0, '2013-10-28 17:53:11', '0000-00-00 00:00:00'),
(2, 'http://hw3/index.php/teem', '', 'http://hw3/index.php/geekhub', '', 1, 0, '2013-10-30 09:58:07', '0000-00-00 00:00:00');

-- --------------------------------------------------------

--
-- Table structure for table `dj0kq_schemas`
--

CREATE TABLE IF NOT EXISTS `dj0kq_schemas` (
  `extension_id` int(11) NOT NULL,
  `version_id` varchar(20) NOT NULL,
  PRIMARY KEY (`extension_id`,`version_id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8;
...
--
-- Dumping data for table `dj0kq_schemas`
--

INSERT INTO `dj0kq_schemas` (`extension_id`, `version_id`) VALUES
(700, '2.5.14');

-- --------------------------------------------------------

--
-- Table structure for table `dj0kq_session`
--

CREATE TABLE IF NOT EXISTS `dj0kq_session` (
  `session_id` varchar(200) NOT NULL DEFAULT '',
  `client_id` tinyint(3) unsigned NOT NULL DEFAULT '0',
  `guest` tinyint(4) unsigned DEFAULT '1',
  `time` varchar(14) DEFAULT '',
...
--
-- Dumping data for table `dj0kq_session`
--

INSERT INTO `dj0kq_session` (`session_id`, `client_id`, `guest`, `time`, `data`, `userid`, `username`, `usertype`) VALUES
('64f5239742a0474a33a84d723b27ab3e', 1, 0, '1383150356', '__default|a:8:{s:22:"session.client.browser";s:76:"Mozilla/5.0 (X11; Ubuntu; Linux x86_64; rv:24.0) Gecko/20100101 Firefox/24.0";s:15:"session.counter";i:9;s:8:"registry";O:9:"JRegistry":1:{s:7:"\0*\0data";O:8:"stdClass":4:{s:11:"application";O:8:"stdClass":1:{s:4:"lang";s:0:"";}s:11:"com_modules";O:8:"stdClass":1:{s:7:"modules";O:8:"stdClass":1:{s:6:"filter";O:8:"stdClass":1:{s:18:"client_id_previous";i:0;}}}s:9:"com_menus";O:8:"stdClass":2:{s:5:"items";O:8:"stdClass":2:{s:6:"filter";O:8:"stdClass":1:{s:8:"menutype";s:8:"mainmenu";}s:10:"limitstart";i:0;}s:4:"edit";O:8:"stdClass":1:{s:4:"item";O:8:"stdClass":3:{s:4:"data";N;s:4:"type";N;s:4:"link";N;}}}s:4:"item";O:8:"stdClass":1:{s:6:"filter";O:8:"stdClass":1:{s:8:"menutype";s:8:"mainmenu";}}}}s:4:"user";O:5:"JUser":25:{s:9:"\0*\0isRoot";b:1;s:2:"id";s:3:"791";s:4:"name";s:10:"Super User";s:8:"username";s:4:"root";s:5:"email";s:19:"galina.ck@gmail.com";s:8:"password";s:65:"f59fa21775a80f422cd92b19026efa26:4UGTgrll9IdQVNqq4hYFVUfQN7MdT73D";s:14:"password_clear";s:0:"";s:8:"usertype";s:10:"deprecated";s:5:"block";s:1:"0";s:9:"sendEmail";s:1:"1";s:12:"registerDate";s:19:"2013-10-23 19:55:10";s:13:"lastvisitDate";s:19:"2013-10-30 13:27:16";s:10:"activation";s:1:"0";s:6:"params";s:0:"";s:6:"groups";a:1:{i:8;s:1:"8";}s:5:"guest";i:0;s:13:"lastResetTime";s:19:"0000-00-00 00:00:00";s:10:"resetCount";s:1:"0";s:10:"\0*\0_params";O:9:"JRegistry":1:{s:7:"\0*\0data";O:8:"stdClass":0:{}}s:14:"\0*\0_authGroups";a:2:{i:0;i:1;i:1;i:8;}s:14:"\0*\0_authLevels";a:4:{i:0;i:1;i:1;i:1;i:2;i:2;i:3;i:3;}s:15:"\0*\0_authActions";N;s:12:"\0*\0_errorMsg";N;s:10:"\0*\0_errors";a:0:{}s:3:"aid";i:0;}s:13:"session.token";s:32:"fbebe85f631afa8b81b12da1799735f2";s:19:"session.timer.start";i:1383150170;s:18:"session.timer.last";i:1383150355;s:17:"session.timer.now";i:1383150356;}', 791, 'root', ''),
('c4092b66f0a52c860b558067817cdd0a', 0, 1, '1383150635', '__default|a:7:{s:15:"session.counter";i:3;s:19:"session.timer.start";i:1383150428;s:18:"session.timer.last";i:1383150585;s:17:"session.timer.now";i:1383150635;s:22:"session.client.browser";s:76:"Mozilla/5.0 (X11; Ubuntu; Linux x86_64; rv:24.0) Gecko/20100101 Firefox/24.0";s:8:"registry";O:9:"JRegistry":1:{s:7:"\0*\0data";O:8:"stdClass":0:{}}s:4:"user";O:5:"JUser":25:{s:9:"\0*\0isRoot";b:0;s:2:"id";i:0;s:4:"name";N;s:8:"username";N;s:5:"email";N;s:8:"password";N;s:14:"password_clear";s:0:"";s:8:"usertype";N;s:5:"block";N;s:9:"sendEmail";i:0;s:12:"registerDate";N;s:13:"lastvisitDate";N;s:10:"activation";N;s:6:"params";N;s:6:"groups";a:0:{}s:5:"guest";i:1;s:13:"lastResetTime";N;s:10:"resetCount";N;s:10:"\0*\0_params";O:9:"JRegistry":1:{s:7:"\0*\0data";O:8:"stdClass":0:{}}s:14:"\0*\0_authGroups";a:1:{i:0;i:1;}s:14:"\0*\0_authLevels";a:2:{i:0;i:1;i:1;i:1;}s:15:"\0*\0_authActions";N;s:12:"\0*\0_errorMsg";N;s:10:"\0*\0_errors";a:0:{}s:3:"aid";i:0;}}', 0, '', '');

-- --------------------------------------------------------

--
-- Table structure for table `dj0kq_template_styles`
--

CREATE TABLE IF NOT EXISTS `dj0kq_template_styles` (
  `id` int(10) unsigned NOT NULL AUTO_INCREMENT,
  `template` varchar(50) NOT NULL DEFAULT '',
  `client_id` tinyint(1) unsigned NOT NULL DEFAULT '0',
  `home` char(7) NOT NULL DEFAULT '0',
...
--
-- Dumping data for table `dj0kq_template_styles`
--

INSERT INTO `dj0kq_template_styles` (`id`, `template`, `client_id`, `home`, `title`, `params`) VALUES
(2, 'bluestork', 1, '1', 'Bluestork - Default', '{"useRoundedCorners":"1","showSiteName":"0"}'),
(3, 'atomic', 0, '0', 'Atomic - Default', '{}'),
(4, 'beez_20', 0, '0', 'Beez2 - Default', '{"wrapperSmall":"53","wrapperLarge":"72","logo":"images\\/joomla_black.gif","sitetitle":"Joomla!","sitedescription":"Open Source Content Management","navposition":"left","templatecolor":"personal","html5":"0"}'),
(5, 'hathor', 1, '0', 'Hathor - Default', '{"showSiteName":"0","colourChoice":"","boldText":"0"}'),
(6, 'beez5', 0, '0', 'Beez5 - Default', '{"wrapperSmall":"53","wrapperLarge":"72","logo":"images\\/sampledata\\/fruitshop\\/fruits.gif","sitetitle":"Joomla!","sitedescription":"Open Source Content Management","navposition":"left","html5":"0"}'),
(7, 'hw3', 0, '0', 'hw3 - Default', '{}'),
(8, 'hw3_01', 0, '0', 'hw3_01 - Default', '{"wrapperSmall":53,"wrapperLarge":72,"logo":"","sitetitle":"","sitedescription":"","navposition":"center","html5":0}'),
(9, 'hw3_main01', 0, '1', 'hw3_main01 - Default', '{"wrapperSmall":53,"wrapperLarge":72,"logo":"images\\/geekhub_logo.png","sitetitle":"","sitedescription":"3-d seasone registration is closed","navposition":"center","html5":0}');

-- --------------------------------------------------------

--
-- Table structure for table `dj0kq_updates`
--

CREATE TABLE IF NOT EXISTS `dj0kq_updates` (
  `update_id` int(11) NOT NULL AUTO_INCREMENT,
  `update_site_id` int(11) DEFAULT '0',
  `extension_id` int(11) DEFAULT '0',
  `categoryid` int(11) DEFAULT '0',
...
--
-- Dumping data for table `dj0kq_updates`
--

INSERT INTO `dj0kq_updates` (`update_id`, `update_site_id`, `extension_id`, `categoryid`, `name`, `description`, `element`, `type`, `folder`, `client_id`, `version`, `data`, `detailsurl`, `infourl`) VALUES
...
--
-- Table structure for table `dj0kq_update_categories`
--

CREATE TABLE IF NOT EXISTS `dj0kq_update_categories` (
  `categoryid` int(11) NOT NULL AUTO_INCREMENT,
  `name` varchar(20) DEFAULT '',
  `description` text NOT NULL,
  `parent` int(11) DEFAULT '0',
...
--
-- Table structure for table `dj0kq_update_sites`
--

CREATE TABLE IF NOT EXISTS `dj0kq_update_sites` (
  `update_site_id` int(11) NOT NULL AUTO_INCREMENT,
  `name` varchar(100) DEFAULT '',
  `type` varchar(20) DEFAULT '',
  `location` text NOT NULL,
...
--
-- Dumping data for table `dj0kq_update_sites`
--

INSERT INTO `dj0kq_update_sites` (`update_site_id`, `name`, `type`, `location`, `enabled`, `last_check_timestamp`) VALUES
(1, 'Joomla Core', 'collection', 'http://update.joomla.org/core/list.xml', 1, 1383044430),
(2, 'Joomla Extension Directory', 'collection', 'http://update.joomla.org/jed/list.xml', 1, 1383044430),
(3, 'Accredited Joomla! Translations', 'collection', 'http://update.joomla.org/language/translationlist.xml', 1, 1383044430);

-- --------------------------------------------------------

--
-- Table structure for table `dj0kq_update_sites_extensions`
--

CREATE TABLE IF NOT EXISTS `dj0kq_update_sites_extensions` (
  `update_site_id` int(11) NOT NULL DEFAULT '0',
  `extension_id` int(11) NOT NULL DEFAULT '0',
  PRIMARY KEY (`update_site_id`,`extension_id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8 COMMENT='Links extensions to update sites';
...
--
-- Dumping data for table `dj0kq_update_sites_extensions`
--

INSERT INTO `dj0kq_update_sites_extensions` (`update_site_id`, `extension_id`) VALUES
(1, 700),
(2, 700),
(3, 600);
...
--
-- Table structure for table `dj0kq_usergroups`
--

CREATE TABLE IF NOT EXISTS `dj0kq_usergroups` (
  `id` int(10) unsigned NOT NULL AUTO_INCREMENT COMMENT 'Primary Key',
  `parent_id` int(10) unsigned NOT NULL DEFAULT '0' COMMENT 'Adjacency List Reference Id',
  `lft` int(11) NOT NULL DEFAULT '0' COMMENT 'Nested set lft.',
  `rgt` int(11) NOT NULL DEFAULT '0' COMMENT 'Nested set rgt.',
...
--
-- Dumping data for table `dj0kq_usergroups`
--

INSERT INTO `dj0kq_usergroups` (`id`, `parent_id`, `lft`, `rgt`, `title`) VALUES
(1, 0, 1, 20, 'Public'),
(2, 1, 6, 17, 'Registered'),
(3, 2, 7, 14, 'Author'),
(4, 3, 8, 11, 'Editor'),
...
--
-- Table structure for table `dj0kq_users`
--

CREATE TABLE IF NOT EXISTS `dj0kq_users` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `name` varchar(255) NOT NULL DEFAULT '',
  `username` varchar(150) NOT NULL DEFAULT '',
  `email` varchar(100) NOT NULL DEFAULT '',
...
--
-- Dumping data for table `dj0kq_users`
--

INSERT INTO `dj0kq_users` (`id`, `name`, `username`, `email`, `password`, `usertype`, `block`, `sendEmail`, `registerDate`, `lastvisitDate`, `activation`, `params`, `lastResetTime`, `resetCount`) VALUES
(791, 'Super User', 'root', 'galina.ck@gmail.com', 'f59fa21775a80f422cd92b19026efa26:4UGTgrll9IdQVNqq4hYFVUfQN7MdT73D', 'deprecated', 0, 1, '2013-10-23 19:55:10', '2013-10-30 16:22:51', '0', '', '0000-00-00 00:00:00', 0);

-- --------------------------------------------------------

--
-- Table structure for table `dj0kq_user_notes`
--

CREATE TABLE IF NOT EXISTS `dj0kq_user_notes` (
  `id` int(10) unsigned NOT NULL AUTO_INCREMENT,
  `user_id` int(10) unsigned NOT NULL DEFAULT '0',
  `catid` int(10) unsigned NOT NULL DEFAULT '0',
  `subject` varchar(100) NOT NULL DEFAULT '',
...
--
-- Table structure for table `dj0kq_user_profiles`
--

CREATE TABLE IF NOT EXISTS `dj0kq_user_profiles` (
  `user_id` int(11) NOT NULL,
  `profile_key` varchar(100) NOT NULL,
  `profile_value` varchar(255) NOT NULL,
  `ordering` int(11) NOT NULL DEFAULT '0',
...
--
-- Table structure for table `dj0kq_user_usergroup_map`
--

CREATE TABLE IF NOT EXISTS `dj0kq_user_usergroup_map` (
  `user_id` int(10) unsigned NOT NULL DEFAULT '0' COMMENT 'Foreign Key to #__users.id',
  `group_id` int(10) unsigned NOT NULL DEFAULT '0' COMMENT 'Foreign Key to #__usergroups.id',
  PRIMARY KEY (`user_id`,`group_id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8;
...
--
-- Dumping data for table `dj0kq_user_usergroup_map`
--

INSERT INTO `dj0kq_user_usergroup_map` (`user_id`, `group_id`) VALUES
(791, 8);

-- --------------------------------------------------------

--
-- Table structure for table `dj0kq_viewlevels`
--

CREATE TABLE IF NOT EXISTS `dj0kq_viewlevels` (
  `id` int(10) unsigned NOT NULL AUTO_INCREMENT COMMENT 'Primary Key',
  `title` varchar(100) NOT NULL DEFAULT '',
  `ordering` int(11) NOT NULL DEFAULT '0',
  `rules` varchar(5120) NOT NULL COMMENT 'JSON encoded access control.',
...
--
-- Dumping data for table `dj0kq_viewlevels`
--

INSERT INTO `dj0kq_viewlevels` (`id`, `title`, `ordering`, `rules`) VALUES
(1, 'Public', 0, '[1]'),
(2, 'Registered', 1, '[6,2,8]'),
(3, 'Special', 2, '[6,3,8]');
...
--
-- Table structure for table `dj0kq_weblinks`
--

CREATE TABLE IF NOT EXISTS `dj0kq_weblinks` (
  `id` int(10) unsigned NOT NULL AUTO_INCREMENT,
  `catid` int(11) NOT NULL DEFAULT '0',
  `sid` int(11) NOT NULL DEFAULT '0',
  `title` varchar(250) NOT NULL DEFAULT '',
